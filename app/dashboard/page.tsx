...
// ✨ 1. Impor komponen chart baru yang akan kita gunakan
...
interface DashboardStats {
  ...
  // ✨ 2. Tambahkan state untuk data chart komposisi
...
export default function DashboardPage() {
  const [stats, setStats] = useState<DashboardStats>({
    ...
    totalRevenue: 0,
    monthlyTrend: [],
    wasteComposition: [], // Inisialisasi state baru
  })
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      // ✨ 3. Siapkan data untuk chart komposisi
      ...
      setStats({
        ...
        totalRevenue,
        monthlyTrend,
        wasteComposition, // Masukkan data baru ke state
      })
    } catch (error) {
      toast({
        title: "Error",
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ✨ 4. Ubah layout grid untuk menampung dua chart ✨ */}
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        {/* ✨ 5. Tambahkan kartu baru untuk chart komposisi ✨ */}
